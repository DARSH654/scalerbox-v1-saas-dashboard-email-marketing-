...
import FEATURE_NOT_USED from './sample/feature-not-used';
import ONBOARDING_CHECKLIST from './sample/onboarding-checklist';
import ONE_TIME_PASSCODE from './sample/one-time-passcode';
import PAYMENT_FAILED from './sample/payment-failed';
...
import TRIAL_ENDING_SOON from './sample/trial-ending-soon';
import TRIAL_EXPIRED from './sample/trial-expired';
import TRIAL_START from './sample/trial-start';
...
export default function getConfiguration(template: string) {
  if (template.startsWith('#sample/')) {
    ...
    switch (sampleName) {
      case 'welcome':
        return WELCOME;
      case 'feature-not-used':
        return FEATURE_NOT_USED;
