...
const BRAND_BLUE = '#4F7CF3'; // Primary gradient start color
const BRAND_GRADIENT = 'linear-gradient(to right, #4F7CF3, #8E3AF7)'; // Primary gradient
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedSecondary: {
          background: 'linear-gradient(135deg, #4F7CF3 0%, #8E3AF7 100%)', // Primary Gradient
          border: 'none',
          color: BASE_THEME.palette.common.white,
          '&:hover, &:active, &:focus': {
            background: 'linear-gradient(135deg, #4568D9 0%, #7B2FD6 100%)', // Darker gradient on hover
            border: 'none',
            color: BASE_THEME.palette.common.white,
          },
        },
        containedPrimary: {
          background: 'linear-gradient(135deg, #4F7CF3 0%, #8E3AF7 100%)',
          color: '#ffffff',
          '&:hover': {
            background: 'linear-gradient(135deg, #4568D9 0%, #7B2FD6 100%)',
          },
        },
      },
    },
